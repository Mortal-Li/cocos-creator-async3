 ...
 * 跟数学相关的方法
 * @author Mortal-Li
 * @created Tue Apr 16 2024 18:36:37 GMT+0800 (中国标准时间)
 */
...
export default class MathHelper {
     ...
     */
    static randomV2(w: number, h: number, centerP: Vec2 = Vec2.ZERO) {
        return v2(w * (Math.random() - 0.5), h * (Math.random() - 0.5)).add(centerP);
    }
